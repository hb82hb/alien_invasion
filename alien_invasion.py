...
class AlienInvasion:
    ...
    def _start_game(self, event):
        """Start game when player presses p"""
        if not self.stats.game_active:
            #Reset game stats
    ...
    def _check_bullet_alien_collisions(self):
        """Respond to collisions with aliens"""
        #Remove any bullets and aliens that have collided
        #Check if any bullets hit any aliens,
        #If they have, destroy the alien and the bullet
    ...
    def _update_aliens(self):
        ...
        then update the position of aliens in the fleet
        """
        ...
        #Look for aliens colliding with the bottom of the window
    ...
    def _create_fleet(self):
        ...
        #Spacing beween each alien is equal to one alien width
        alien = Alien(self)
        ...
        #Create the fulll fleet of aliens
